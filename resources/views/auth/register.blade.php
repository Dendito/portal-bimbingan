          ...
          <div class="card-body px-4 py-5 px-md-5">
            ...
            @csrf
              ...
              <div class="form-outline mb-4">
                  ...
                  <select name="jeniskelamin" placeholder="Masukkan jenis kelamin" id="jeniskelamin" class="form-select">
              ...
              <!-- Submit button -->
              <br>
              <button type="submit" class="btn btn-primary btn-block mb-3 ms-2">
                {{ __('Register') }}
              </button>
